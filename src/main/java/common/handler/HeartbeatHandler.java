...
public abstract class HeartbeatHandler
	...
	protected void channelRead0(ChannelHandlerContext context, ByteBuf byteBuf)
		...
		if (byteBuf.getByte(4) == PING_MSG) {
			...
			System.out.println(name + " get pong msg from "
	...
	protected void sendPingMsg(ChannelHandlerContext context) {
		...
		heartbeatCount++;
		System.out.println(
				name + " sent ping msg to " + context.channel().remoteAddress()
	...
	private void sendPongMsg(ChannelHandlerContext context) {
		...
		heartbeatCount++;
		System.out.println(
				name + " sent pong msg to " + context.channel().remoteAddress()
						+ ", count: " + heartbeatCount);
	}
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		System.err.println(
				"---" + ctx.channel().remoteAddress() + " is active---");
	}
